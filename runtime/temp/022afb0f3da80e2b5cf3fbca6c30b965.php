...
<div class="layui-side layui-bg-black">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="node_name" value="<?php echo $data['node_name']; ?>" lay-verify="required" autocomplete="off"
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="node_url" lay-verify="required"
                       placeholder="请输入节点路径" value="<?php echo $data['node_url']; ?>"  autocomplete="off" class="layui-input">
            </div>
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <select name="pid" >
                		...
                		<option value="<?php echo $data['new_id']; ?>"><?php echo $data['new_name']; ?></option>
    ...
    $(function(){
        layui.use(['form', 'layer'], function(){
            ...
            form.on('submit(*)', function(data){
                ...
                $.post(
                        '<?php echo url("Power/PowerUpdate"); ?>',
                        data.field,
                        function( data ){
                            if( data.status == 1000 ){
                                alert('ok');
