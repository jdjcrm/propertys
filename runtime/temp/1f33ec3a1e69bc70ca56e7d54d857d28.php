<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:90:"E:\PHPserver\wwwroot\default\aliyun_1805\public/../application/admin\view\login\login.html";i:1590630201;}*/ ?>
...
<div class="login-aside">
  ...
  <div id="o-box-down"  style="table-layout:fixed;">
   ...
   <div class="fm-item">
	   <label for="logonId" class="form-label">物业系统登陆：</label>
	   <input type="text" placeholder="输入账号" name="admin_name"
              value='admin' lay-verify="required|username" class="i-text">
  ...
  <div class="fm-item">
	   ...
	   <input type="password"
             value="adminadmin" maxlength="100" name="admin_pwd"
 ...
 <!--  <div class="fm-item pos-r">
  ...
  <div class="fm-item">
	   ...
	   <input type="submit" id='logins' value="" lay-submit lay-filter="*" tabindex="4" id="send-btn" class="btn-login">
       <div class="ui-form-explain"></div>
  </div>
  </form>
  </div>
