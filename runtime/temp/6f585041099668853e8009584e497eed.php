    ...
    layui.use(['table','layer'], function(){
        ...
        table.render({
            ...
            ,cols: [[
                ...
                ,{field:'brand_describe', title: '内容介绍',edit:'text'} //minWidth：局部定义当前单元格的最小宽度，layui 2.2.1 新增
