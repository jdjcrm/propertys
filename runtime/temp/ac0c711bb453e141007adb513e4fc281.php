...
<div class="layui-side layui-bg-black">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="phone_name" value="<?php echo $data['phone_name']; ?>" autocomplete="off" placeholder="请输入名称" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">电话号</label>
        <div class="layui-input-block">
            <input type="text" name="phone"  value="<?php echo $data['phone']; ?>" autocomplete="off" placeholder="请输入电话" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-input-block">
    ...
    $(function(){
        layui.use(['form','layer'], function(){
            ...
            form.on('submit(*)',function(data){
                $.post(
                        "<?php echo url('Phone/phoneUpdate'); ?>",
                        data.field,
                        function(msg){
