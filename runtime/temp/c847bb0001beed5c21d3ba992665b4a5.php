...
<script>
    layui.use(['table','layer'], function(){
        ...
        table.render({
            elem: '#test'
            ,url:'<?php echo url("Role/roleList"); ?>'
            ,limit: 10
        ...
        table.on('tool(test)', function(obj){ //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
            ...
            if(layEvent === 'detail'){ //查看
                location.href="<?php echo url('Role/roleUpdateInfo'); ?>?role_id="+data.role_id;
