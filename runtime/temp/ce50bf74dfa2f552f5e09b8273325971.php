...
<div class="layui-side layui-bg-black">
    ...
    <div class="layui-body" style="width:1200px;">
        ...
        <div style="padding: 15px;">
            <h1>你没有权限访问该页面，如果需要访问，请联系管理员</h1>
        </div>
    </div>
</div>
<script>
