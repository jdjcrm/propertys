...
<div class="layui-side layui-bg-black">
    ...
    <input type="hidden" value="<?php echo $data['feedback_id']; ?>" id="feedback_id" name="feedback_id">
   
    <div class="layui-form-item layui-form-text">
        <label class="layui-form-label">反馈内容</label>
        <div class="layui-input-block">
            <textarea placeholder="请输入内容" name="feedback_content" class="layui-textarea" lay-verify="required"><?php echo $data['feedback_content']; ?></textarea>
        </div>
    </div>
     ...
     <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="user" value="<?php echo $data['user']; ?>"  autocomplete="off" placeholder="请输入名称" class="layui-input">
        </div>
    </div>
    ...
    $(function(){
        layui.use(['form','layer','upload'], function(){
            ...
            form.on('submit(*)',function(data){
                $.post(
                        "<?php echo url('Feedback/feedbackUpdate'); ?>",
                        data.field,
                        function(msg){
                            layer.msg(msg.font,{icon:msg.code});
                            if(msg.code==1){
                                location.href="<?php echo url('Feedback/feedbackList'); ?>";
                            }
                        },'json'
                )
                return false;
