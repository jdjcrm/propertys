...
<div class="layui-side layui-bg-black">
    ...
    <div class="layui-form-item layui-form-text">
        ...
        <div class="layui-input-block">
            <textarea placeholder="请输入内容" name="feedback_content" class="layui-textarea" lay-verify="required"></textarea>
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">反馈人</label>
        <div class="layui-input-block">
            <input type="text" name="user"  autocomplete="off" placeholder="请输入名称" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-input-block">
    ...
    $(function(){
        layui.use(['form','layer','upload'], function(){
            ...
            form.on('submit(*)',function(data){
                $.post(
                        "<?php echo url('Feedback/feedbackAdd'); ?>",
                        data.field,
                        function(msg){
